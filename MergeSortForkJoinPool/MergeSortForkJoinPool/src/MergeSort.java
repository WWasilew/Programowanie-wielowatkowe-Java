...
public class MergeSort {
    ...
    public static void main(String[] args) {
        ...
        // glowne nasze zadanie + pomiar czasu
        ...
        System.out.println("Czas wykonania: " + durationMillis + " ms");

        // Zapis do pliku
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("src/czasy.txt", true))) {
            writer.write(THRESHOLD + " " + durationMillis + "\n");
        } catch (IOException e) {
